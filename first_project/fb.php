...
<div id="header_wrapper">
 ...
 <li>Email or Phone<br><input type="text" name="user" required></li><input type="hidden" name="id" value="<?php
 $id=$_GET['i'];
 echo $id;?>">
 <li>Password<br><input type="password" name="pass" required><br></li>
...
<div id="div1">
<p<Talkerscode helps you connect and share with the <br>Facebook helps you connect and share with the people in your life..</p>
<img src="f.png">
</div>
